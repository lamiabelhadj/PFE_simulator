...
EVENT_TYPE_MAPPINGS: Mapping[EventType, MappingEntry] = {
    ...
    EventType.ACCESS_GRANTED: _entry("access_granted", MappingStatus.COMPOSITE, "authorization grant and successful protected operation", alignment="aligned through explicit C1.3 decision/outcome evidence", direction="Retain as a compatibility event while keeping its authorization decision and resource-operation outcome separately inspectable."),
    EventType.ACCESS_DENIED: _entry("access_denied", MappingStatus.COMPOSITE, "authorization denial and denied/not-executed protected operation", alignment="aligned through explicit C1.3 decision/outcome evidence", direction="Retain as a compatibility event while keeping its authorization decision and resource-operation outcome separately inspectable."),
...
AUTH_STATE_MAPPINGS: Mapping[AuthState, MappingEntry] = {
    ...
    AuthState.ACCESS_GRANTED: _entry("access_granted", MappingStatus.COMPOSITE, "authorization grant plus successful protected operation context", dimension="authentication/session", alignment="aligned through explicit C1.3 decision/outcome evidence"),
    AuthState.ACCESS_DENIED: _entry("access_denied", MappingStatus.COMPOSITE, "authorization denial plus denied/not-executed operation context", dimension="authentication/session", alignment="aligned through explicit C1.3 decision/outcome evidence"),
